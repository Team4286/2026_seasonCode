...
public final class dataTable {
    ...
    private static final ShotEntry[] SHOT_TABLE = {
        ...
        new ShotEntry(0.5, 0.20, 0.75),
        new ShotEntry(1, 0.35, 0.75),
        new ShotEntry(2, 0.50, 0.75),
        new ShotEntry(3, 0.75, 0.75),
        new ShotEntry(4, 0.95, 0.75),
        new ShotEntry(4.5, 1, 0.75),
    };
